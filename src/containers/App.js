  ...
  render() {
    return (
      <div className="App">    
          ...
          <p className="col-xs-12 footer-link"> Made by Shivashish Yadav | MIT license | <a href="https://github.com/ShivashishY/employed-days" title="Employed Days Calculator on Github" target="_blank" rel="noopener noreferrer"> View on Github</a> </p>
      </div>
    );
  }
}
